...
<head>
    ...
    <SCRIPT language=javascript>
        ...
        function selectCustomer(this_cust_id, this_cust_name) {
            /* 详细步骤
            //获得添加页面的window对象
            ...
            //简写步骤
            //获得父窗口对象后 并获得其docunment对象 并获得其元素 并赋值
            window.opener.document.getElementById("cust_id").value = this_cust_id;
            window.opener.document.getElementById("cust_name").value = this_cust_name;
            //关闭本窗口
            window.close();
        }
    </SCRIPT>
    ...
    <TR>
        ...
        <TD vAlign=top width="100%" bgColor=#ffffff>
            <TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
                <TR>
                    <TD class=manageHead>当前位置：客户管理 &gt; 联系人列表</TD>
                </TR>
                <TR>
                    <TD height=2></TD>
                </TR>
                ...
                <TR>
                    <TD height=25>
                        <FORM id="pageForm" name="customerForm"
                              ...
                              method=post>
                            <%--设置隐藏域，使用提交表单的方式，使每次操作都可以向后台传递参数--%>
                            <!-- 隐藏域.当前页码 -->
                            ...
                            <TABLE cellSpacing=0 cellPadding=2 border=0>
                                ...
                                <TR>
                                    ...
                                    <%--${param.参数名} 意指取参数的意思，取的是request传递的参数，这里相当于把自己又给取出来了--%>
                            ...
                            <s:iterator value="#pageBean.list" var="linkman">
                                <TR
                                    ...
                                    <TD>
                                        ...
                                        <s:else>
                                            <%--被弹窗打开，则显示选择按钮，点击时调用方法，传递id和name两个参数--%>
                                            <INPUT type="button" value="选择"
                                                   onclick="selectCustomer(
                                                       <s:property value="#cust.cust_id"/> ,'<s:property
                    ...
                    <TD>
                        <SPAN id=pagelink>
                            <DIV style="LINE-HEIGHT: 20px; HEIGHT: 20px; TEXT-ALIGN: right">
                                共[ <B><s:property value="#pageBean.totalCount"/></B> ]条记录,共[ <B><s:property
