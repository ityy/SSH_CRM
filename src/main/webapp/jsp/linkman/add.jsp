...
<FORM id=form1 name=form1
      ...
      method=post>
    <%--添加隐藏域 当修改信息时 让对象为游离态 从而使后台采用更新方法--%>
                ...
                <TABLE cellSpacing=0 cellPadding=5 border=0>
                    <tr>
                        ...
                        <td colspan="3">
                            ...
                            <input type="hidden" name="customer.cust_id" id="cust_id"
                                   value="<s:property value="#linkMan.customer.cust_id" />"/>
                            <%--不需要name属性 名字只看不传--%>
                            <input type="text" id="cust_name" style="WIDTH: 180px"
                                   value="<s:property value="#linkMan.customer.cust_name" />"/>
                    ...
                    <TR>
                        ...
                        <td>
                            ...
                            <%--使用三元表达式 条件?真则:假则 来判断是否选中--%>
                            <%--数据库中lkm_gender是char类型--%>
                            <s:property value="#linkMan.lkm_gender=='1'?'checked':''"/>
                            >男
                            <input type="radio" value="2" name="lkm_gender"
                            <s:property value="#linkMan.lkm_gender=='2'?'checked':''" />
                            >女
                        </td>
                    </TR>
                    <TR>
                        ...
                        <td>
                            <INPUT class=textbox id=sChannel2
                                   ...
                                   value="<s:property value="#linkMan.lkm_phone" />"
                            >
                        </td>
                        <td>联系人手机 ：</td>
                        <td>
                            <INPUT class=textbox id=sChannel2
                                   ...
                                   value="<s:property value="#linkMan.lkm_mobile" />"
