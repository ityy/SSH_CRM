                                ...
                                <TD>
                                    <TABLE cellSpacing=0 cellPadding=2 border=0>
                                        ...
                                        <TR>
                                            <%--
                                                两个图形按钮
                                                    一个用input的image类型 可以提交表单
                                                    一个用img标签避免冲突

                                                添加鼠标手型指针:
                                                    style="cursor: pointer;"

                                                两个TD标签会让上边的TD也跟下边的对齐,应该使用colspan进行列合并
                                            --%>
                                            <%--<TD>--%>
                                                <%--<INPUT id=btn--%>
                                                       <%--style="BORDER-TOP-WIDTH: 0px; BORDER-LEFT-WIDTH: 0px; BORDER-BOTTOM-WIDTH: 0px; BORDER-RIGHT-WIDTH: 0px"--%>
                                                       <%--type=image src="images/login_button.gif" style="cursor: pointer;" name=btn>--%>
                                            <%--</TD>--%>
                                            <%--<TD> &nbsp;&nbsp;<img src="images/regist_button.png" style="cursor: pointer;" onclick="window.location.href='${pageContext.request.contextPath}/regist.jsp'" >--%>
                                            <%--</TD>--%>
                                                <TD colspan="2" ><INPUT id=btn
                                                                        style="BORDER-TOP-WIDTH: 0px; BORDER-LEFT-WIDTH: 0px; BORDER-BOTTOM-WIDTH: 0px; BORDER-RIGHT-WIDTH: 0px"
                                                                        type=image src="images/login_button.gif" name=btn >
                                                    <img src="images/regist_button.png" style="cursor: pointer;" onclick="window.location.href='regist.jsp'" >
                                                </TD>
                                        </TR>
                                        </TBODY>
                                    </TABLE>
